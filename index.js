...
const CategoriaRoutes = require('./src/routes/Cateoria');  // Verifica que el nombre del archivo sea correcto
...
const corsOptions = {
  ...
  preflightContinue: true, // Si presentas problemas, prueba eliminar esta opción o ponerla en false
};
...
// Si no se está ejecutando en Vercel, inicia el servidor de forma local
